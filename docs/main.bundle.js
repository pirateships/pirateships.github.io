        ...
        if (this.channel) {
            ...
            this.pubnub.getMessage(this.channel, function (message) {
                ...
                if (JSON.parse(message.message).data.status === 'finished') {
                    _this.userBoard = null;
                    _this.alexaBoard = null;
                    _this.finished = true;
                }
            });
        }
